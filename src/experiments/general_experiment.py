...
_SYSTEM = flags.DEFINE_enum_class('system', None, eSystem, 'Which system to run.')
...
def run_job(job: Job) -> None:
    ...
    try:
        ...
        # required commands
        cmd += f' --config {FLAGS.config_path}:{FLAGS.system.value}@{FLAGS.experiment}@C{job.case_idx}'
